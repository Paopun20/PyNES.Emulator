...
class PynesFileHandler(logging.Handler):
    def __init__(self, file_name: Union[str, Path]) -> None:
        ...
        self._log_hold: List[Tuple[logging.LogRecord, Exception]] = []
